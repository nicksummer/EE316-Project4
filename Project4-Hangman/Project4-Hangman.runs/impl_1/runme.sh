...
HD_PWD='C:/Users/nicks/Documents/EE136-Project4-Hangman/Project4-Hangman/Project4-Hangman.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Level_Hangman.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Level_Hangman.tcl -notrace
