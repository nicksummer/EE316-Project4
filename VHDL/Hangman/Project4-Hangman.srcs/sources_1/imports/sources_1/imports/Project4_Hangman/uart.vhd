...
architecture rtl of uart is
    ...
    signal rx_is_empty    :std_logic:= '1';
    signal tx_is_empty    :std_logic;
    SIGNAl RXCLK_last     : std_logic;
    SIGNAl txCLK_last     : std_logic;
begin
    -- UART RX Logic
    ...
    if (rising_edge(clk)) then
        ...
        if (rx_enable = '1' and rxclk_last='0' and rxclk='1') then
...
--                    end if;
                ...
                if (tx_enable = '1' and tx_is_empty = '0' and txclk_last='0' and txclk='1' ) then
                    tx_cnt <= tx_cnt + 1;
                    if (tx_cnt = 0) then
                        tx_out <= '0';
                    end if;
