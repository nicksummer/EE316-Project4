...
HD_PWD='C:/Users/nicks/Documents/EE136-Project4-Hangman/Project4-Hangman/Project4-Hangman.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log Top_Level_Hangman.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Level_Hangman.tcl
